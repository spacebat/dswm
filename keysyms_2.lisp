...
(defun keysym->dswm-name (keysym)
  "Return the name corresponding to KEYSYM."
  (let ((key (get-key-by-keysym keysym *keys*)))
    (when-not-null key (dswm-key-dswm-name key))))
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;depreceted. Keep for back compatability;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;; KEYSYM-NAME->KEYSYM."
;;   (let ((key-by-dswm-name (get-key-by-dswm-name dswm-name *keys*))
;; 	(key-by-name (get-key-by-keysym-name dswm-name *keys*)))
;;     (if (null key-by-dswm-name)
;; 	(dswm-key-keysym-name key-by-name)
;; 	(dswm-key-dswm-name key-by-dswm-name))))
